...
- Se incorpora el horizonte astronómico del observador como círculo rojo perpendicular a la línea cenit–nadir. El texto `HORIZONTE DEL OBSERVADOR` aparece dos veces, en puntos opuestos, y cada letra sigue realmente la curvatura proyectada del círculo al girar la esfera. La mitad posterior de línea y texto se atenúa para conservar la profundidad. Este horizonte depende de la posición del observador; no se confunde con el horizonte visible de la mar.

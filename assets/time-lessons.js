(function(){
const S={
 932:{title:"Junio 2015 · P13",from:"HcG",to:"HcL",fromName:"hora civil en Greenwich",toName:"hora civil del lugar",clock:"10:10:00",clockDate:"",lon:"110°10′ E",lonDeg:110+10/60,dir:"E",sign:"+",offset:"7 h 20 min 40 s",offsetDms:"7°20′40″",raw:"17:30:40",final:"17:30:40",dateResult:"misma fecha",answer:"C",lonTokens:["1","1","0","°′″","1","0","°′″"],clockTokens:["1","0","°′″","1","0","°′″"],resultScreen:"17°30′40″"},
 892:{title:"Noviembre 2015 · P13",from:"HcL",to:"HcG",fromName:"hora civil del lugar",toName:"hora civil en Greenwich",clock:"04:10:00",clockDate:"22 de noviembre de 2015",lon:"60°10′ E",lonDeg:60+10/60,dir:"E",sign:"−",offset:"4 h 00 min 40 s",offsetDms:"4°00′40″",raw:"00:09:20",final:"00:09:20",dateResult:"22 de noviembre de 2015",answer:"A",lonTokens:["6","0","°′″","1","0","°′″"],clockTokens:["4","°′″","1","0","°′″"],resultScreen:"0°09′20″"},
 690:{title:"Junio 2017 · P11",from:"HcL",to:"HcG",fromName:"hora civil del lugar",toName:"hora civil en Greenwich",clock:"21:30:00",clockDate:"25 de junio de 2017",lon:"56°35′ E",lonDeg:56+35/60,dir:"E",sign:"−",offset:"3 h 46 min 20 s",offsetDms:"3°46′20″",raw:"17:43:40",final:"17:43:40",dateResult:"25 de junio de 2017",answer:"D",lonTokens:["5","6","°′″","3","5","°′″"],clockTokens:["2","1","°′″","3","0","°′″"],resultScreen:"17°43′40″"},
 132:{title:"Junio 2022 · P13",from:"HcL",to:"HcG",fromName:"hora civil del lugar",toName:"hora civil en Greenwich",clock:"12:03:42",clockDate:"",lon:"1°44,5′ W",lonDeg:-(1+44.5/60),dir:"W",sign:"+",offset:"0 h 06 min 58 s",offsetDms:"0°06′58″",raw:"12:10:40",final:"12:10:40",dateResult:"misma fecha",answer:"A",lonTokens:["1","°′″","4","4",".","5","°′″"],clockTokens:["1","2","°′″","3","°′″","4","2","°′″"],resultScreen:"12°10′40″"},
 610:{title:"Marzo 2018 · P11",from:"HcL",to:"HcG",fromName:"hora civil del lugar",toName:"hora civil en Greenwich",clock:"22:10:10",clockDate:"9 de marzo de 2018",lon:"5°05′ W",lonDeg:-(5+5/60),dir:"W",sign:"+",offset:"0 h 20 min 20 s",offsetDms:"0°20′20″",raw:"22:30:30",final:"22:30:30",dateResult:"9 de marzo de 2018",answer:"D",lonTokens:["5","°′″","5","°′″"],clockTokens:["2","2","°′″","1","0","°′″","1","0","°′″"],resultScreen:"22°30′30″"},
 330:{title:"Julio 2020 · P11",from:"HcG",to:"HcL",fromName:"hora civil en Greenwich",toName:"hora civil del lugar",clock:"22:30:00",clockDate:"28 de marzo de 2020",lon:"66°20′ E",lonDeg:66+20/60,dir:"E",sign:"+",offset:"4 h 25 min 20 s",offsetDms:"4°25′20″",raw:"26:55:20",final:"02:55:20",dateResult:"29 de marzo de 2020",answer:"A",wrap:"− 24 h y avanza un día",lonTokens:["6","6","°′″","2","0","°′″"],clockTokens:["2","2","°′″","3","0","°′″"],resultScreen:"2°55′20″"},
 972:{title:"Marzo 2015 · P13",from:"HcG",to:"HcL",fromName:"hora civil en Greenwich",toName:"hora civil del lugar",clock:"22:30:00",clockDate:"28 de marzo de 2015",lon:"66°20′ E",lonDeg:66+20/60,dir:"E",sign:"+",offset:"4 h 25 min 20 s",offsetDms:"4°25′20″",raw:"26:55:20",final:"02:55:20",dateResult:"29 de marzo de 2015",answer:"B",wrap:"− 24 h y avanza un día",lonTokens:["6","6","°′″","2","0","°′″"],clockTokens:["2","2","°′″","3","0","°′″"],resultScreen:"2°55′20″"}
};
const IDS=new Set(Object.keys(S).map(Number));
function guide(s,id){
 const expected=[...s.lonTokens,"÷","1","5","=",...s.clockTokens,s.sign,"Ans","="];
 const formulaEnd=s.lonTokens.length+4,inverseEnd=expected.length;
 if(s.wrap)expected.push("−","2","4","°′″","=");
 const directions=expected.map((key,i)=>i<s.lonTokens.length?`Introduce la longitud ${s.lon}; ahora pulsa ${key}.`:i===s.lonTokens.length?"Divide la longitud entre 15 para convertirla en tiempo.":i===s.lonTokens.length+1?"Escribe la primera cifra de 15.":i===s.lonTokens.length+2?"Completa el divisor 15.":i===s.lonTokens.length+3?"Pulsa = para obtener el tiempo de longitud tL.":i<formulaEnd+s.clockTokens.length?`Introduce ${s.from} = ${s.clock}; pulsa ${key}.`:i===formulaEnd+s.clockTokens.length?`${s.from} → ${s.to} con longitud ${s.dir}: pulsa ${s.sign}.`:i===formulaEnd+s.clockTokens.length+1?"Pulsa Ans para reutilizar el tiempo de longitud ya calculado.":i===formulaEnd+s.clockTokens.length+2?"Pulsa = para obtener la hora resultante.":i===expected.length-5?"Como supera 24 h, resta 24.":i===expected.length-4?"Escribe 2.":i===expected.length-3?"Escribe 4.":i===expected.length-2?"Pulsa °′″ para introducir 24 horas exactas.":"Pulsa =: ya tienes la hora normalizada y debes avanzar un día.");
 return {kind:"time",id,s,expected,directions,formulaEnd,inverseEnd,milestones:[{at:formulaEnd,value:s.offsetDms},{at:inverseEnd,value:s.wrap?s.raw.replaceAll(":","°").replace(/°(\d\d)°/,"°$1′").replace(/(\d\d)$/,"$1″"):s.resultScreen},...(s.wrap?[{at:expected.length,value:s.resultScreen}]:[])],storageKey:`aprobarNautica_timeTrainer_${id}_v1`,finalText:`${s.to} = ${s.final} · ${s.dateResult}. Respuesta ${s.answer}.`,subtitle:`${s.title} · conversión directa entre ${s.from} y ${s.to}.`,objective:`Objetivo: ${s.to} = ${s.final} · ${s.dateResult}`,initial:`Empieza convirtiendo la longitud ${s.lon} en tiempo: introdúcela y divide entre 15.`,firstFeedback:`tL = ${s.offset}. Ahora aplica la regla ${s.from} → ${s.to}: longitud ${s.dir}, se ${s.sign==="+"?"suma":"resta"}.`,secondFeedback:s.wrap?`La cuenta da ${s.raw}. Una hora civil debe quedar entre 00:00 y 23:59: resta 24 h y avanza un día.`:"",steps:`<li>Convertir la longitud en tiempo: tL = L ÷ 15.</li><li>Aplicar ${s.to} = ${s.from} ${s.sign} tL.</li><li>${s.wrap?"Restar 24 h y cambiar al día siguiente.":"Comprobar que la fecha no cambia."}</li>`};
}
window.TIME_DIRECT_SOLUTIONS=S;window.TIME_DIRECT_LESSON_IDS=IDS;window.TIME_CALCULATOR_GUIDES={};Object.entries(S).forEach(([id,s])=>window.TIME_CALCULATOR_GUIDES[`time-${id}`]=guide(s,id));

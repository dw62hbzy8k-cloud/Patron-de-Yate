...
function trainerMarkup(guideId){
 ...
 const is1010=guideId==="1010",is1258=guideId==="1258",is98=guideId==="98",is334=guideId==="334",isHeight=is296||is1010||is1258||is98||is334||guideId==="1";
 const subtitle=is334?"Cálculo interactivo de Julio 2020 · Modelo 1 · P15.":is98?"Cálculo interactivo de Noviembre 2022 · Modelo 2 · P19.":is1258?"Cálculo interactivo de Junio 2024 · pregunta 19 · Vega.":is1010?"Cálculo interactivo de Junio 2026 · Modelo 1 · P11.":is296?"Cálculo interactivo de esta pregunta: altura estimada del Sol.":guideId?"Cálculo interactivo completo de la altura estimada del Sol.":"Convertir grados decimales en grados y minutos.";
 const objective=is334?"Objetivo de esta pregunta: ae = 52°27,9′":is98?"Objetivo de esta pregunta: ae = 25°27′18″":is1258?"Objetivo de esta pregunta: ae* = 77°04′57″":is1010?"Objetivo de esta pregunta: ae = 63°56,2′":is296?"Objetivo de esta pregunta: ae = 51°14,1′":guideId?"Objetivo: ae = 44°53,7′":"Objetivo: 44,895188° = 44°53,7′";
...
function mount(root){
 ...
 const height296=guideId==="296",height1010=guideId==="1010",height1258=guideId==="1258",height98=guideId==="98",height334=guideId==="334",heightGuide=guideId==="1"||height296||height1010||height1258||height98||height334;
 const expected=height334?height334Expected:height98?height98Expected:height1258?height1258Expected:height1010?height1010Expected:height296?height296Expected:heightGuide?heightExpected:conversionExpected,directions=height334?height334Directions:height98?height98Directions:height1258?height1258Directions:height1010?height1010Directions:height296?height296Directions:heightGuide?heightDirections:conversionDirections,storageKey=height334?HEIGHT_334_STORAGE_KEY:height98?HEIGHT_98_STORAGE_KEY:height1258?HEIGHT_1258_STORAGE_KEY:height1010?HEIGHT_1010_STORAGE_KEY:height296?HEIGHT_296_STORAGE_KEY:heightGuide?HEIGHT_STORAGE_KEY:STORAGE_KEY;
 const finalHeightText=height334?"ae = 52°27′52,4″, que en las respuestas es 52°27,9′.":height98?"ae = 25°27′18,2″, que en las respuestas es 25°27′18″.":height1258?"ae* = 77°04′57,2″, que en las respuestas es 77°04′57″.":height1010?"ae = 63°56′14,1″, que en las respuestas es 63°56,2′.":height296?"ae = 51°14′06,4″, que en las respuestas es 51°14,1′.":"ae = 44°53,7′.";
 const milestones=height334?[{at:53,value:"0.792976"},{at:58,value:"52.464543"},{at:59,value:"52°27′52,4″"}]:height98?[{at:58,value:"0.429803"},{at:63,value:"25.455066"},{at:64,value:"25°27′18,2″"}]:height1258?[{at:58,value:"0.974693172380"},{at:63,value:"77.082554214"},{at:64,value:"77°04′57,2″"}]:height1010?[{at:50,value:"0.8983134026"},{at:55,value:"63.9372496"},{at:56,value:"63°56′14,1″"}]:height296?[{at:55,value:"0.779722"},{at:60,value:"51.235123"},{at:61,value:"51°14′06,4″"}]:[{at:61,value:"0.7058120802"},{at:66,value:"44.8951881663"},{at:70,value:"0.8951881663"},{at:74,value:"53.7112899782"}];
 const formulaEnd=height334?53:height98?58:height1258?58:height1010?50:height296?55:61,inverseEnd=height334?58:height98?63:height1258?63:height1010?55:height296?60:66;

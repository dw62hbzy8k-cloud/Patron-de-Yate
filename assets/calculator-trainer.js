...
function buildTrueAltitudeGuide(guideId){
 ...
 return {kind:"true-altitude",id,s,expected,directions,formulaEnd,inverseEnd,milestones,storageKey:`aprobarNautica_trueAltitudeTrainer_${id}_v1`,finalText:`av = ${s.av}. Respuesta ${s.answer}.`,subtitle:`Cálculo interactivo de ${s.title} · de altura instrumental a altura verdadera.`,objective:`Objetivo: av = ${s.av} · respuesta ${s.answer}`,initial:`Empieza con ai = ${s.ai}; la guía aplicará las cuatro correcciones en su orden.`,firstFeedback:`Corrección de índice aplicada: ao = ${s.observed}. Ahora aplica la depresión del horizonte.`,secondFeedback:`Depresión aplicada: aa = ${s.apparent}. Ahora añade la corrección de la Tabla B y termina con la corrección adicional.`,steps:"<li>Aplicar la corrección de índice y obtener ao.</li><li>Aplicar la depresión del horizonte y obtener aa.</li><li>Aplicar Tabla B y corrección adicional para obtener av.</li>"};
}

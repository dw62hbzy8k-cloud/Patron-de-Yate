...
function mount(root){
 ...
 function render(){expressionEl.textContent=expression;resultEl.textContent=pretty(display);expressionEl.scrollLeft=expressionEl.scrollWidth;resultEl.scrollLeft=resultEl.scrollWidth;instructionEl.textContent=cursor<expected.length?directions[cursor]:heightGuide?"Cálculo completo: ae = 44° 53,7′.":"Ejercicio terminado: 44,895188° = 44° 53,7′.";updateSteps();updateKeyState();updateProgress()}
